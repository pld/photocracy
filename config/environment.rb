...
Rails::Initializer.run do |config|
  ...
  config.gem 'gnuplot'
  config.gem 'htmlentities' # only used in gnuplot utilities
  config.gem 'flickraw' #if PRODUCTION # will raise exception on launch if no internet connection
